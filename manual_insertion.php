...
$milestonesQuary = "SELECT * FROM dbShnkr23stud2.tbl_221_milestones;";
...
if(!empty($_GET['instanceId'])){
    $studentQuary = "SELECT * FROM dbShnkr23stud2.tbl_221_cycles WHERE cycleID = '" . $_GET['instanceId'] . "';";
echo $studentQuary;
    $studentResult = mysqli_query($connection, $studentQuary);
    if ($studentResult) {
...
<header class="d-flex align-items-center ">
    ...
    <aside class="d-md-flex d-none d-md-inline d-flex flex-column  ">
        ...
        <div id="wrapper" class="container">
            ...
            <form action="save_instance.php" method="POST">
                <div class="form-floating mb-3 col-12">
                    <input type="text" class="form-control required" id="Name" <?php if (!empty($_GET['instanceId'])) {
                        echo 'value ="' . $studentRow["cycle_name"] . '"';
                    } ?> name="Name" placeholder="Milestone Name"><label
                        for="Name">Milestone Name</label>
                </div>
                <div class="item-goal mt-5 ">
                    <h3 class="text-center">Items Collected</h3>
                    <label id="warning-label" class="mb-3 d-flex justify-content-center">*Must have at least one
                        item</label>
                        ...
                        <div class="col-12 col-md-8 ">
                            <div class="input-group ">
                                <input type="number" name="bottles" class="form-control " id="numOfPlastics"
                                    placeholder="Number of plastics " <?php if (!empty($_GET['instanceId'])) {
                                        echo 'value ="' . $studentRow["bottles"] . '"';
                        ...
                        <div class="col-12 col-md-8 ">
                            <div class="input-group ">
                                <input type="number" name="cans" class="form-control" id="numOfCans"
                                    placeholder="Number of cans " <?php if (!empty($_GET['instanceId'])) {
                                        echo 'value ="' . $studentRow["cans"] . '"';
                                    } ?> aria-label="Input group example " aria-describedby="cans "
                                    min=0>
                        ...
                        <div class="col-12 col-md-8 ">
                            <div class="input-group ">
                                <input type="number" name="boxes" class="form-control" id="numOfBoxes"
                                    placeholder="Number of cardboards " <?php if (!empty($_GET['instanceId'])) {
                                        echo 'value ="' . $studentRow["boxes"] . '"';
                                    } ?> aria-label="Input group example "
                    ...
                    <section class = "input-group d-flex row justify-content-center container mb-3">
                    ...
                    <div class="input-group d-flex row justify-content-center mb-3" id="datepicker">
                        ...
                        <section class="col-4">
                            <input type="date" class="form-control " id="Date" name="Date" <?php if (!empty($_GET['instanceId'])) {
                                echo 'value = ' . date($studentRow["cycleDate"]);
                            } ?> placeholder="End date"
                                aria-label="Input group example" aria-describedby="datepicker">
                    </div>
                    </section>
                </div>
                <?php 
                if(isset($_GET['instanceId'])){
                   echo '<input type="hidden" name = "instanceId" value="'.$_GET['instanceId'].'">';
                }
                ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <span> Are you sure you your milestone is ready to be submitted?</span>
                                </div>
