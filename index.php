...
<body>
    ...
    <section id="login">
        <form action="" method="post" id="frm">
            ...
            <button type="submit" class="btn btn-outline-success fix2">Log me in!</button>
        ...
        <div class="container-log">
            <ul
                class="middle-list d-flex align-items-center justify-content-evenly col-6 place-icons-login">
                <li>
