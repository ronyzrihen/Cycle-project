<?php 
    ...
    $query  = "SELECT * FROM tbl_221_milestones where milestone_id=" . $milestone_id;
    ...
    <main class="d-flex flex-row-reverse">
        ...
        <div id="wrapper" class="container-fluid">
            ...
            <section class="d-md-flex ">
                <section>
                    <div class="p-3 mb-2 col-12 bg-white text-dark text-center">Milestones name:
                        <span class="color"> &nbsp <?php echo $row['milestone_name']; ?></span>
                    </div>
                    <div class="p-3 mb-2 col bg-white text-dark">End date:
                        <label class="color"> &nbsp <?php echo $row['end_date']; ?></label>
                    </div>
                    <div class="p-3 mb-2 col bg-white text-dark">Cans:
                        <label class="color">&nbsp <?php echo $row['cans']; ?> <i class="fa-solid fa-database"></i></label>
                    </div>
                    <div class="p-3 mb-2 col bg-white text-dark ">Bottles:
                        <label class="color">&nbsp <?php echo $row['bottles']; ?><i class="fa-solid fa-bottle-water"></i></label>
                    </div>
                    <div class="p-3 mb-2 col bg-white text-dark">Cardboards:
                        <label class="color">&nbsp <?php echo $row['boxes']; ?> <i class="fa-solid fa-box-open"></i></label>
                    </div>
                    <div class="p-3 mb-2 col bg-white text-dark">Badge: &nbsp
                        <img id="imgsizes" src="<?php echo $row['milestone_photo']; ?>" alt="spiderman">
                    </div>
                </section>
